...
@section('content')
    <h2 class="text-2xl font-bold text-black mb-4">Daftar Siswa</h2>
    <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
        <div class="container mx-auto mt-8">
            <div class="mb-4">
                <a href="{{ route('siswa.create') }}">
                    <button class="bg-blue-500 text-white py-2 px-4 rounded">Tambah Siswa</button>
                        ...
                        <tbody class="text-gray-800">
                            ...
                            @foreach ($student as $item)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b text-center">{{ $item['nis'] }}</td>
                                    <td class="py-2 px-4 border-b text-center">{{ $item['name'] }}</td>
                                    <td class="py-2 px-4 border-b text-center">{{ $item->rombel->rombel }}</td>
                                    <td class="py-2 px-4 border-b text-center">{{ $item->rayon->rayon }}</td>
