...
@section('content')
    <div class="container mx-auto mt-8">
        <form action="{{ route('rombel.update', $rombel['id']) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            @method('PATCH')
            <div class="mb-4">
                ...
                <input type="text" id="rombel" name="rombel"
                    ...
                    placeholder="Masukkan rombel" required value="{{ $rombel->rombel }}">
            </div>
