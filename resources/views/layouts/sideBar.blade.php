...
<body class="bg-white">
    <nav class="bg-gray-800 p-4 text-white">
        ...
        <div class="navbar-right">
            <span>admin</span>
            <!-- Tambahkan tulisan Administrator di navbar bagian kanan -->
    ...
    <div class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900">
        ...
        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold" id="submenu">
            <a href="{{ route('rombel.index') }}"><h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">
                Data Rombel
            </h1></a>
            <a href="{{ route('rayon.index') }}"><h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">
                Data Rayon
            </h1></a>
            <a href="{{ route('siswa.index') }}"><h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">
                Data Siswa
            </h1></a>
            <a href="{{ route('user.data') }}"><h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">
                Data User
            </h1></a>
        </div>
        <div
            ...
            <span class="text-[15px] ml-4 text-gray-200 font-bold">Data Keterlambatan</span>
        </div>
    </div>
